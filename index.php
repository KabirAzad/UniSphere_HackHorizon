...
<div class="container" style="padding-top: 3rem;">
    ...
    <div class="grid grid-3" style="margin-bottom: 4rem;">
        <?php foreach($featured_stores as $store): ?>
            <div class="glass" style="padding: 1.5rem; display: flex; align-items: center; gap: 15px; transition: transform 0.3s ease; cursor: pointer;" onmouseover="this.style.transform='translateY(-5px)'" onmouseout="this.style.transform='translateY(0)'">
                <div style="width: 60px; height: 60px; background: rgba(59, 130, 246, 0.1); border: 1px solid rgba(59, 130, 246, 0.3); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.5rem; color: var(--primary); flex-shrink: 0;">
                    <i class="fas fa-store"></i>
                </div>
                <div>
                    <h3 style="margin-bottom: 5px; font-size: 1.1rem;"><?php echo htmlspecialchars($store['store_name'] ?? 'Store'); ?></h3>
                    <p style="color: var(--text-muted); font-size: 0.85rem; margin-bottom: 0;"><i class="fas fa-star" style="color: #f59e0b;"></i> 4.8 (Top Rated)</p>
                </div>
            </div>
        <?php endforeach; ?>
    ...
    <h2 style="margin-bottom: 1.5rem; text-align: center;">How UniSphere Works <i class="fas fa-magic" style="color: #f59e0b; font-size: 1.5rem;"></i></h2>
    <div class="grid grid-3" style="margin-bottom: 4rem;">
        <div class="glass text-center" style="padding: 2rem;">
            <div style="width: 70px; height: 70px; background: rgba(16, 185, 129, 0.1); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 1.5rem; color: var(--accent); font-size: 2rem; border: 1px solid rgba(16, 185, 129, 0.3);">
                <i class="fas fa-store"></i>
            </div>
            <h3 style="margin-bottom: 1rem;">1. Choose & Order</h3>
            <p style="color: var(--text-muted); font-size: 0.95rem; line-height: 1.5;">Browse products from local campus stores, canteens, and stationery shops. Place your order instantly.</p>
        </div>
        <div class="glass text-center" style="padding: 2rem;">
            <div style="width: 70px; height: 70px; background: rgba(59, 130, 246, 0.1); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 1.5rem; color: var(--primary); font-size: 2rem; border: 1px solid rgba(59, 130, 246, 0.3);">
                <i class="fas fa-motorcycle"></i>
            </div>
            <h3 style="margin-bottom: 1rem;">2. Fast Delivery</h3>
            <p style="color: var(--text-muted); font-size: 0.95rem; line-height: 1.5;">A fellow student (UniRider) picks up and delivers your order straight to your hostel or class across the campus.</p>
        </div>
        <div class="glass text-center" style="padding: 2rem;">
            <div style="width: 70px; height: 70px; background: rgba(245, 158, 11, 0.1); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 1.5rem; color: #f59e0b; font-size: 2rem; border: 1px solid rgba(245, 158, 11, 0.3);">
                <i class="fas fa-coins"></i>
            </div>
            <h3 style="margin-bottom: 1rem;">3. Earn Rewards</h3>
            <p style="color: var(--text-muted); font-size: 0.95rem; line-height: 1.5;">Riders earn UniCoins for every valid delivery. Members earn cashback. Redeem for awesome perks.</p>
        </div>
    </div>
    ...
    <div class="glass" style="padding: 3rem 2rem; margin-top: 4rem; border-radius: 16px; background: linear-gradient(to right, rgba(0,0,0,0.3), rgba(245, 158, 11, 0.05)); border-left: 4px solid #f59e0b; display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; gap: 2rem;">
        <div style="flex: 1; min-width: 300px;">
            ...
            <ul style="list-style: none; padding: 0; margin-bottom: 0;">
                ...
                <li style="margin-bottom: 10px; color: var(--text-main); display: flex; align-items: center;"><i class="fas fa-check-circle" style="color: #10b981; margin-right: 10px; font-size: 1.2rem;"></i> Up to 5% Cashback on Store Orders (Students)</li>
    ...
    <!-- Campus Testimonials -->
    <h2 style="margin-top: 5rem; margin-bottom: 1.5rem; text-align: center;">Hear From The Campus <i class="fas fa-heart" style="color: #ef4444; font-size: 1.5rem;"></i></h2>
    <div class="grid grid-3" style="margin-bottom: 2rem;">
        <div class="glass" style="padding: 2rem; position: relative; overflow: hidden; transition: transform 0.3s ease;" onmouseover="this.style.transform='translateY(-5px)'" onmouseout="this.style.transform='translateY(0)'">
            <i class="fas fa-quote-right" style="position: absolute; right: 20px; top: 20px; font-size: 3rem; color: rgba(255,255,255,0.03);"></i>
            <div style="display: flex; gap: 2px; color: #f59e0b; margin-bottom: 1rem;">
                <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
            </div>
            <p style="color: var(--text-muted); font-style: italic; margin-bottom: 1.5rem; min-height: 80px;">"Life saver! Ordered a textbook right before my exam from the stationery shop, and a UniRider delivered it in 10 mins."</p>
            <div style="display: flex; align-items: center; gap: 15px;">
                <div style="width: 40px; height: 40px; background: rgba(16, 185, 129, 0.2); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: var(--accent); font-weight: bold;">R</div>
                <div>
        ...
        <div class="glass" style="padding: 2rem; position: relative; overflow: hidden; transition: transform 0.3s ease;" onmouseover="this.style.transform='translateY(-5px)'" onmouseout="this.style.transform='translateY(0)'">
            ...
            <p style="color: var(--text-muted); font-style: italic; margin-bottom: 1.5rem; min-height: 80px;">"I earn UniCoins just by delivering food to the hostel next to mine. Super easy to pay for my own meals now!"</p>
            <div style="display: flex; align-items: center; gap: 15px;">
                <div style="width: 40px; height: 40px; background: rgba(59, 130, 246, 0.2); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: var(--primary); font-weight: bold;">A</div>
                <div>
        ...
        <div class="glass" style="padding: 2rem; position: relative; overflow: hidden; transition: transform 0.3s ease;" onmouseover="this.style.transform='translateY(-5px)'" onmouseout="this.style.transform='translateY(0)'">
            ...
            <p style="color: var(--text-muted); font-style: italic; margin-bottom: 1.5rem; min-height: 80px;">"Our canteen sales jumped by 30% since joining UniSphere. The students handle delivery, we just pack and hand over."</p>
            <div style="display: flex; align-items: center; gap: 15px;">
                <div style="width: 40px; height: 40px; background: rgba(239, 68, 68, 0.2); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: #ef4444; font-weight: bold;">S</div>
                <div>
    ...
    <div class="glass flex-mobile-col" style="padding: 3rem; margin-top: 5rem; margin-bottom: 2rem; background: linear-gradient(135deg, rgba(59,130,246,0.1), rgba(16,185,129,0.1)); border: 1px solid rgba(255,255,255,0.05); border-radius: 16px; display: flex; align-items: center; justify-content: space-between; overflow: hidden; position: relative;">
        ...
        <div style="font-size: 12rem; color: rgba(255,255,255,0.03); line-height: 1; z-index: 1; position: absolute; right: -20px; bottom: -20px;" class="hero-icon-mobile-hide">
...
<!-- Simple Footer -->
<footer style="text-align: center; padding: 2.5rem 0; color: var(--text-muted); border-top: 1px solid rgba(255,255,255,0.05); margin-top: 2rem; background: rgba(0,0,0,0.2);">
    ...
    <div style="margin-top: 10px;">
        <a href="#" style="color: var(--text-muted); margin: 0 10px;text-decoration: none;"><i class="fab fa-instagram"></i></a>
        <a href="#" style="color: var(--text-muted); margin: 0 10px;text-decoration: none;"><i class="fab fa-twitter"></i></a>
        <a href="#" style="color: var(--text-muted); margin: 0 10px;text-decoration: none;"><i class="fab fa-linkedin"></i></a>
    </div>
</footer>
